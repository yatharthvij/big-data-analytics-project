...
│   └── presentation/                 Executive deck — 9 slides (HTML + PDF), click-through nav
...
| Data Engineering & Architecture | 4 | `notebooks/01_data_engineering.ipynb` · Report §3–4 · Deck slide 4 |
| Feature Engineering & Data Preparation | 3 | `notebooks/01_data_engineering.ipynb` §4 · Report §4.3 |
| Machine Learning Implementation | 4 | `notebooks/02_ml_modeling.ipynb` (3 approaches) · Report §5.1–5.3 · Deck slides 6–7 |
| Model Evaluation & Interpretation | 2 | `docs/*-results.md` weaknesses sections · baseline/threshold/silhouette analyses · Deck slide 5 |
| Business Recommendations & Strategic Value | 2 | Report §6–7 · Deck slides 5, 8 |
